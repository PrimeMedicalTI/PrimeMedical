...
Alterar o parametro MV_PCOMPRA e colocar FSRCOM01 para substituir a impressão padrão.

---------------------------------------------------------------------------------------------*/

User Function FSRCOM01(cNumPed)
...
While (_cAlias)->(!Eof())
	...
	oPrn:say(nLin,0116,Substr((_cAlias)->C7_PRODUTO,1,25)		, oFont08)		//codigo
	oPrn:say(nLin,0370,Substr((_cAlias)->B1_DESC,1,70)			, oFont08)		//descricao
	oPrn:say(nLin,1900,Transform((_cAlias)->C7_QUANT,cQuantPict), oFont08)		//Quantidade
	oPrn:say(nLin,2100,(_cAlias)->C7_UM							, oFont08)		//unidade de medida
	oPrn:say(nLin,2300,Transform((_cAlias)->C7_PRECO,cPrecoPict), oFont08)		//VLR UNIT
	oPrn:say(nLin,2600,Transform((_cAlias)->C7_TOTAL,cTotalPict), oFont08)		//VLR TOT
	oPrn:say(nLin,2900,Transform((_cAlias)->C7_IPI,cIPIPict)	, oFont08)		//IPI
	...
	c_CodPg :=  (_cAlias)->C7_COND + " - " + Posicione("SE4",1,xFilial("SE4")+ (_cAlias)->C7_COND,"E4_DESCRI")
...
_cFileLogo	:= "Marca.bmp" // "DANFE01.bmp"	
oPrn:SayBitMap(0070,0100,_cFileLogo,0400,0200)
...
oPrn:line(485,0035,485,3425)    //Linha Horizontal Cabecalho Inferior
oPrn:line(545,0035,545,3425)    //Linha Horizontal Cabecalho Inferior
...
oPrn:say (nLin,0116,STR0020,oFont08I) //"Código"
oPrn:say (nLin,0370,STR0022,oFont08I) //"Descrição" 
oPrn:say (nLin,1900,STR0019,oFont08I) //"Qtde" 
oPrn:say (nLin,2100,STR0041,oFont08I) //unidade de medida
...
_nTot := (_nTot + _nValIpi)
//+ _nValIcmR  + _nDespesa + _nSeguro - _nDescPed)
...
nLin += 70
oPrn:say (nLin,0035,"OBSERVAÇÃO:", oFont10N) 
oPrn:say (nLin,0250,;
If(lLGPD,RetTxtLGPD(Substr((_cAlias)->C7_OBS,1,250),"C7_OBS"),(_cAlias)->C7_OBS),oFont10)
nLin += 52
oPrn:say(nLin,0035,STR0031+"  "+DTOC(_dDtEnt),oFont08) 										//"Prazo Programado p/ Entrega:"
oPrn:say(nLin,1700,"Condição de  Pagamento: "+ c_CodPg,oFont08) 			  			   //"Cond. Pag."
nLin += 50
...
cQuery += " SC7.C7_VALICM,SC7.C7_DT_EMB, SC7.C7_TOTAL, SC7.C7_CODTAB, SC7.C7_SEGURO, SC7.C7_DESPESA, C7_COND, C7_OBS, "
If cPaisLoc == "BRA"
