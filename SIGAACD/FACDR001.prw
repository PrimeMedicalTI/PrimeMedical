...
a_Descr:=o_Prime:mtdSeparaPalavra(c_Descr, 36, 2)
...
@ 0,00 PSay "^FO16,380^GB770,0,3,B^FS"
...
Endif
@ 0,00 PSay "^FO30,150^AAN,014,010^FH_^FDDESCRICAO:^FS"
//@ 0,00 PSay "^FO30,170^A0N,030,040^FH_^FD"+c_Descr+"^FS"
n_Lin:=150
For n_X:=1 To Len(a_Descr)
	n_Lin+=40
	@ 0,00 PSay "^FO30,"+Str(n_Lin,3)+"^A0N,030,040^FH_^FD"+a_Descr[n_X]+"^FS"
Next
n_Lin+=70
@ 0,00 PSay "^FO30,"+Str(n_Lin,3)+"^AAN,014,010^FH_^FDEMBALAGEM:^FS"
n_Lin+=40
@ 0,00 PSay "^FO30,"+Str(n_Lin,3)+"^A0N,030,040^FH_^FD"+mv_par05+"^FS"
If 	Empty(mv_par02)=.F.
	n_Lin+=70
	@ 0,00 PSay "^FO30,"+Str(n_Lin,3)+"^A0N,030,040^FH_^FDLote: ^FS"
	@ 0,00 PSay "^FO150,"+Str(n_Lin,3)+"^A0N,030,040^FH_^FD"+mv_par02+"^FS"
	@ 0,00 PSay "^FO430,"+Str(n_Lin,3)+"^A0N,030,040^FH_^FDValidade: "+DToC(mv_par03)+"^FS"
	n_Lin+=60
	@ 0,00 PSay "^FO150,"+Str(n_Lin,3)+"^BY2,1,67^BCN, 67,Y,N,N,N^FD"+mv_par02+"^FS"
Endif
...
o_perg:mtdPutSX1(c_Perg		,"01"		,"Produto"			,""			,""			,"mv_ch1"	,"C"		,TamSX3("B1_COD")[1]	,0			,0			,"G"	,""			,"mv_par01"	,""			,""					,""					,""			,""					,""					,""					,""			,""					,""					,""					,""			,""					,""					,""				,""			,""			,""			,""			,""			,""			,""			,""			,""			,"SB1"	 ,""		,""			,""			,""			,""	)
