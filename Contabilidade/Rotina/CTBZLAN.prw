...
@ 96,42 TO 323,505 DIALOG oDlg5 TITLE "Limpar Flag Integração Contábil"
@ 8,10 TO 84,222
@ 23,15 SAY "Este programa inicializa os registros do Período selecionados,"
...
Close(oDlg5)
If mv_par07 <> 4
	RptStatus({||L_receb()}  , "Aguarde","Limpando registros do conta a receber provisão/baixa")
Endif
If mv_par08 <> 4
	RptStatus({||L_pagar()}  , "Aguarde","Limpando registros do conta a pagar provisão/baixa")
Endif
If mv_par09 <> 4
	RptStatus({||L_movim()}  , "Aguarde","Limpando registros movimentação bancária")
Endif
If mv_par10 <> 4
...
Endif
If mv_par14==1
	RptStatus({||L_ativo()}  , "Aguarde","Limpando registros do ativo/depreciação")
Endif
If mv_par17==1
	RptStatus({||L_caixa()}  , "Aguarde","Limpando registros do ativo/depreciação")
Endif
...
// Limpar flag contabil da rotina do ativo/depreciação
...
aAdd(aRegs,{cPerg,"14","Ref a Ativo/Deprec   ","","","mv_chE","N", 1,00,0,"C","","mv_par14","Limpar            ","","","","","Não Limpar        ","","","","","                  ","","","","","            ","","","","","     ","","","","","","","","",""})
aAdd(aRegs,{cPerg,"15","De Bem               ","","","mv_chF","C",10,00,0,"G","","mv_par15","                  ","","","","","                  ","","","","","                  ","","","","","            ","","","","","     ","","","","","","","","",""})
aAdd(aRegs,{cPerg,"16","Ate Bem              ","","","mv_chG","C",10,00,0,"G","","mv_par16","                  ","","","","","                  ","","","","","                  ","","","","","            ","","","","","     ","","","","","","","","",""})
aAdd(aRegs,{cPerg,"17","Ref a Caixinha       ","","","mv_chH","N", 1,00,0,"C","","mv_par17","Limpar            ","","","","","Não Limpar        ","","","","","                  ","","","","","            ","","","","","     ","","","","","","","","",""})
